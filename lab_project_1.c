...
void input_nums_second(){
    float a,b,c,left_bord,right_bord,step;
    printf("Введіть a: ");
    scanf("%f",&a);
    printf("Введіть b: ");
    scanf("%f",&b);
...
void func_loop_input(){
    ...
    printf("Введіть крок: ");
    scanf("%f",&step);
    for (x = left_bord; x<right_bord; x+=step){
        if (x>a){
            y = x* pow(x-a,(1.0f/3.0f));
            printf("%f\n",y);
        }
...
int main(){
    ...
    if (choice_programm==1 && choice_input==2){
        ...
        printf("Ви щось неправильно ввели, спробуйте знову");
    }
